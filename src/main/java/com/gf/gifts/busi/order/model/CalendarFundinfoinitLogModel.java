...
*/
@Data
@ApiModel("CalendarFundinfoinitLogModel对象")
public class CalendarFundinfoinitLogModel implements Serializable {
    ...
    @ApiModelProperty(value = "首次购买下限", required = true)
    private BigDecimal orgminfappbalance;

    @ApiModelProperty(value = "最低购买金额", required = true)
    ...
    @ApiModelProperty(value = "最近开放日", required = true)
    private String opendaystartdate;
